FPS.models.flash = (T, o) => {
  ...
  const mat = new T.MeshBasicMaterial({ color: o.color || 0xffe8a7, transparent: true, opacity: .95, toneMapped: false, depthWrite: false, side: T.DoubleSide });
  for (let i = 0; i < 2; i++) {
